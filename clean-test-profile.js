(()=>{
function clean(){
  const list=document.querySelector('#contactList'),counter=document.querySelector('#onlineCounter'),offline=document.querySelector('#offlineCounter'),search=document.querySelector('#contactSearch'),next=document.querySelector('#newChatBtn'),chat=document.querySelector('#chatWindow');
...
function bootAuth(){
  ...
  const s=document.createElement('script');s.src='auth-bootstrap-2005.js?v=20260917-3';s.dataset.msnAuthBootstrap='1';document.body.appendChild(s);
}
